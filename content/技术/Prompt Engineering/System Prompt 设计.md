# 🛠️ System Prompt 设计笔记：掌控 AI 的底层逻辑
...
**核心隐喻：** System Prompt 就像是操作系统的 Root 权限配置文件。它能在全局范围内约束模型的行为、语气、认知边界和输出格式，无论用户在多轮对话中怎么“跑偏”，System Prompt 都能把模型拉回正轨。

---

## 二、 System Prompt 的黄金架构 (The Anatomy)
